...
function bolt_dribbles(p, k, a) {
    ...
    var i = e("<div>").css({
        ...
        height: "100%",
        overflow: "hidden"
    }).addClass("bolt_effect bolt_dribbles").appendTo(a);
    if (!n) {
        var c = e("<canvas>").css({
            position: "absolute",
            left: 0,
    ...
    this.go = function(x, s) {
        if (n) {
            a.find(".bolt_list").css("transform", "translate3d(0,0,0)").stop(true).animate({
...
jQuery("#boltslider-container1").boltSlider({
    effect: "dribbles",
    prev: "",
    next: "",
    duration: 20 * 100,
