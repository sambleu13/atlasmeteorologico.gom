...
@section('title')
    <title>Climatología {{ $product->descripcion}} de {{ $product->nombre}}</title>
@endsection
     ...
     <div class="wrapper_p">
       <div class="row">
           <div class="container-fluid">
		       ...
		       <a href=' {{ asset($product->url_parent)}}' class="button">Atrás</a>
                       <h2>
                           <center>
                              <!-- <a href=' {{ asset($product->url_parent)}}'>-->
                                   <font color="#fff">
                                   <strong>
                                   {{ $product->nombre}}
                                   </strong>
      ...
      <div class="conta">
        <div id='Anima' class="col-lg-12"> 
            ...
            <div class="form-inline form-horizontal col-centered"  >
                ...
                @if($mes!='')
                  {{ Form::open(['id' => 'sefl_moth' ]) }}
                     Mes: 
                    {!! Form::select('sel_moth', $select_cont,$mes,['id' => 'sel_moth' ,'class'=>'btn btn-light btn-custom']) !!}
                  {{ Form::close() }}
                @endif
...
<script language="JavaScript" >
     var images_array= {!! json_encode($images_array) !!};
   //  alert(images_array);
