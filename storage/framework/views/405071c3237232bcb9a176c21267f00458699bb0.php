      ...
      <div class="row">
		...
		<a href="<?php echo e(asset('products#climatologias')); ?>">
			...
			<!--<a href="<?php echo e(asset('products#esc_derrames')); ?>">-->
                          <img src="<?php echo e(asset('/img/mosaico-escenarios-inicio.jpg')); ?>" class="img-responsive">
                          <div class="thumb-name"></div>
                          <div class="thumb-icons">
			...
			<!--<a href="<?php echo e(asset('products#owgis')); ?>" >-->
                          <img src="<?php echo e(asset('img/mosaico-owgis-inicio.jpg')); ?>" class="img-responsive">
                          <div class="thumb-name"></div>
                          <div class="thumb-icons">
                              VISUALIZADOR OWGIS
                          </div>
