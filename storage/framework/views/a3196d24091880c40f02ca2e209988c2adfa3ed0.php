...
<nav role="navigation" class="navbar navbar-default">
    ...
    <div class="navbar-collapse collapse">
      <ul class="nav navbar-nav navbar-right">
        <li class="active markt"><a href="<?php echo e(asset('/index.php')); ?>">
        ...
        <li class="dropdown markt">
          ...
          <ul class="dropdown-menu">
            ...
            <li><a href="<?php echo e(asset('derrames')); ?>" target="_blank"><strong>Escenarios de derrames de petróleo</strong></a></li>
            <li><a href="http://pronosticos.unam.mx:8080/atlasmeteorologico/mapviewer" target="_blank"><strong>Visualizador OWGIS</strong></a></li>

          </ul>
        </li>
        <li class="markt" ><a href="<?php echo e(asset('informacion')); ?>">
            <span class=""></span> Información
          </a></li>
        <li class="markt"><a href="<?php echo e(asset('acerca')); ?>">
            <span class="icon fa fa-envelope"></span> Acerca
          </a></li>
        <li class="markt"><a href="<?php echo e(asset('contact-us')); ?>">
