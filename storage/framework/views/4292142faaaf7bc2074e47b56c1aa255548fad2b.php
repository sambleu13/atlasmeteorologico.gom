	    		...
	    		<div class="col-md-9 col-lg-9">
	    			...
	    			<section id="line1" class="section">
	    				...
	    				<div class="row">
							...
							<p>La página <a href="<?php echo e(asset('acerca')); ?>" target="blank">Acerca</a> presenta al equipo de desarrollo del proyecto, desde las instituciones involucradas, hasta los participantes en la elaboración del Atlas Meteorológico. Al final se muestran los agradecimientos a las instituciones, proyecto y personas que hicieron posible el desarrollo de este proyecto.</p>
							...
							<p>La página <a href="<?php echo e(asset('contact-us')); ?>" target="blank">Contacto</a> permite visualizar la información del grupo de desarrollo del Atlas: la dirección, teléfono, correo electrónico y ubicación, para enviar cualquier comentario, pregunta, sugerencia o propuesta de proyecto.</p>
							...
							<br>
							<p>La visualización de las <a href="<?php echo e(asset('products/viento/rosas_viento')); ?>" target="blank">rosas de viento</a> parte un mapa y mes determinando. El mapa contiene 6 sitios predeterminados. Para acceder a las rosas es necesario entrar primero a las climatologías de viento y ara regresar a otros estadísticos de la variable se oprime el botón atrás.</p>
